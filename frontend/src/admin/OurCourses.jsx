...
const handleDelete = async (id) => {
  ...
  return (
    ...
    <Link
      className="bg-amber-900 py-2 px-4 rounded-lg text-white hover:bg-orange-950 duration-300"
      to={"/admin/dashboard"}
    >
      Go to dashboard
    </Link>
        ...
        <div key={course._id} className="bg-white shadow-md rounded-lg p-4">
          ...
          <div className="flex justify-between">
            <Link
              ...
              className="bg-amber-600 text-white py-2 px-4 mt-4 rounded hover:bg-red-600"
            >
              Update
            </Link>
            <button
